...
\begin{document}
	...
	\begin{example*}
		\textbf{יש כאן טעויות. התוצאה בסוף נכונה, אבל יש טעויות חישוב.}
		בקורדינטות של
		\(\mrm{N} S^2\)
		שלקחנו מתקיים
		\(
	...
	\begin{proof}
		...
		\begin{equation*}\begin{split}
			...
			\\&=\frac{1}{2}\frac{\prt}{\prt r^i}\left(\sum p_\alpha^2+\left(\varphi_\alpha^{-1}\right)^2-2p_\alpha\varphi_\alpha^{-1}\right)
