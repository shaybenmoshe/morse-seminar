...
\begin{document}
	...
	\begin{proof}
		...
		בנקודה:
		\begin{equation*}\begin{split}
			\diff{f}\left(\frac{\prt}{\prt u^i}\right) (g)
			&=\frac{\prt}{\prt u^i}(gf)
			\\&=\frac{\prt}{\prt r^i}\left(g\left(f\left(\varphi^{-1}\right)\right)\right)
			\\&=\frac{1}{2}\frac{\prt}{\prt r^i}\left(\lip p-\varphi^{-1},p-\varphi^{-1} \rip\right) \frac{\dd g}{\dd x}\Big|_{f(q)}
			\\&=\frac{1}{2}\frac{\prt}{\prt r^i}\left(\sum p_\alpha^2+\left(\varphi_\alpha^{-1}\right)^2-p_\alpha\varphi_\alpha^{-1}\right)
			\\&=\sum q_\alpha\frac{\prt x^\alpha}{\prt u^i} -p_\alpha\frac{\prt x^\alpha}{\prt u^i}
